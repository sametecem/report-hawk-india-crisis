  ...
  return (
    <Slide title="11. Sonuç ve İzleme Notları" bgColor="bg-gradient-to-br from-white via-slate-50 to-slate-100">
      <Card className="p-6 shadow-lg bg-white/90 backdrop-blur-sm relative">
        <DownloadButton targetRef={conclusionsRef} filename="sonuc-ve-bulgular" />
        <div ref={conclusionsRef}>
        ...
        <div className="mt-8 relative">
          <DownloadButton targetRef={notesRef} filename="rapor-notlari" className="absolute top-0 right-0" />
          <div ref={notesRef} className="p-5 bg-amber-50 rounded-lg border border-amber-200">
